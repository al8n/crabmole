...
macro_rules! case_ranges {
    ($({$lo:expr, $hi:expr, d{$e1:expr,$e2:expr,$e3:expr}}),* $(,)?) => {
        &[
           $(CaseRange::new($lo, $hi, [$e1, $e2, $e3]),)*
        ]
    };
}

#[allow(non_upper_case_globals)]
const UpperLower: i32 = CaseDelta::UpperLower as i32;

/// [`CASE_RANGES`] is the table describing case mappings for all letters with
/// non-self mappings.
pub const CASE_RANGES: &[CaseRange] = case_ranges! {
...
pub(crate) const ASCII_FOLD: [u16; 256] = {
    const ARR: [u16; 128] = [
...
pub(crate) const CASE_ORBIT: &[FoldPair] = case_orbit! {
    {0x004B, 0x006B},
    {0x0053, 0x0073},
    {0x006B, 0x212A},
    {0x0073, 0x017F},
